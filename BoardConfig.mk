...
TARGET_PREBUILT_KERNEL := device/samsung/tblte/zImage
TARGET_PREBUILT_DTB := device/samsung/tblte/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/tblte/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/tblte/init/init_tblte.cpp
